...
class VisionModel():
    def __init__(self,configs:Config) -> None:
        ...
        self.model = AutoModel.from_pretrained(self.model_name,token=self.access_token)
        self.processor = AutoImageProcessor.from_pretrained(self.model_name, token=self.access_token)
